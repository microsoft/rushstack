...
export class JsonFile {
    ...
    static parse(jsonContents: string): JsonObject;
    ...
    static validate(jsonContents: string, jsonFilename: string, jsonSchema: JsonSchema, options?: IJsonSchemaValidateOptions): JsonObject;
