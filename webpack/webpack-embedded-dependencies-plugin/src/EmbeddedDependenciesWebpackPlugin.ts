...
/**
 * @alpha
 * Data type for a package.json file. This is a subset of the full package.json file and includes additional fields
...
export interface IPackageData extends IPackageJson {
  ...
  /**
   * The author of the package. This is a subset of the full package.json author field.
...
export default class EmbeddedDependenciesWebpackPlugin implements WebpackPluginInstance {
  ...
  public constructor(options?: IEmbeddedDependenciesWebpackPluginOptions) {
    this._outputFileName = options?.outputFileName || 'embedded-dependencies.json';
    ...
    this._generatedLicenseFilename = options?.generatedLicenseFilename || 'THIRD-PARTY-NOTICES.html';
  }
