...
export class AssetProcessor {
  public static processLocalizedAsset(
    ...
    const parsedAsset: IParseResult = _parseStringToReconstructionSequence(
      options.plugin,
      assetSource,
      _getJsonpFunction(options.chunk, options.chunkHasLocalizedModules, options.noStringsLocaleName)
    );
    const reconstructedAsset: ILocalizedReconstructionResult = _reconstructLocalized(
    ...
    const parsedAssetName: IParseResult = _parseStringToReconstructionSequence(
      options.plugin,
      options.assetName,
      () => {
    ...
    const reconstructedAssetName: ILocalizedReconstructionResult = _reconstructLocalized(
  ...
  public static processNonLocalizedAsset(options: IProcessNonLocalizedAssetOptions): IProcessAssetResult {
    ...
    const reconstructedAsset: INonLocalizedReconstructionResult = _reconstructNonLocalized(
      parsedAsset.reconstructionSeries,
      options.asset.size(),
    ...
    const reconstructedAssetName: INonLocalizedReconstructionResult = _reconstructNonLocalized(
      parsedAssetName.reconstructionSeries,
      options.assetName.length,
      options.noStringsLocaleName
    );
