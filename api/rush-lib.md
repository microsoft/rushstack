...
|  [PackageManagerFeatureSet](./rush-lib.packagemanagerfeatureset.md) | <b><i>(BETA)</i></b> Reports the known features of a package manager as detected from its version number. |
