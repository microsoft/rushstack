# gulp-core-build [![Build Status](https://travis-ci.org/dzearing/gulp-core-build.svg?branch=master)](https://travis-ci.org/dzearing/gulp-core-build) [![Dependencies](https://david-dm.org/dzearing/gulp-core-build.svg)](https://david-dm.org/dzearing/gulp-core-build)
