...
| [/build-tests/heft-example-lifecycle-plugin](./build-tests/heft-example-lifecycle-plugin/) | This is an example heft lifecycle plugin that reports the time taken for tasks during execution |
