...
/**
 * Options for package path resolution
 * @public
 */
...
/**
 * Gets the path of a given package name
 * @public
 */
export function resolvePackage(
  ...
  let normalizedRootPath: string = options.doNotResolveSymlinks ? rootPath : FileSystem.getRealPath(rootPath);
...
export function resolvePackagePath(
  ...
  const resolvedPackagePath: string = resolvePackage(packageName, rootPath, options);
