...
// node:crypto is comparatively expensive to load and is only needed when the reporter channel is active.
function randomUUID(): string {
  return (require('node:crypto') as typeof crypto).randomUUID();
}
