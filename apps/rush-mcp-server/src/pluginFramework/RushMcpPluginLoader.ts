...
const _rushMcpJsonSchema: JsonSchema = JsonSchema.fromLoadedObject(rushMcpJsonSchemaObject);
...
function _formatError(e: Error): string {
  return e.stack ?? _formatError(e);
}
