...
import type { APIExtractorTaskConfiguration } from './schemas/api-extractor-task.schema.json.d.ts';
...
const API_EXTRACTOR_CONFIG_SPECIFICATION: ConfigurationFile.IProjectConfigurationFileSpecification<APIExtractorTaskConfiguration> =
  {
