...
export class InstallHelpers {
  ...
  public static generateCommonSplitPackageJson(rushConfiguration: RushConfiguration): void {
    const commonPackageJson: IPackageJson = {
      dependencies: {},
      description: 'Temporary file generated by the Rush tool',
    ...
    const commonPackageJsonFilename: string = path.join(
      rushConfiguration.commonTempSplitFolder,
      FileConstants.PackageJson
    );
  ...
  public static async ensureLocalPackageManager(
    ...
    if (rushConfiguration.hasSplitWorkspaceProject) {
      FileSystem.ensureFolder(rushConfiguration.commonTempSplitFolder);
    }
