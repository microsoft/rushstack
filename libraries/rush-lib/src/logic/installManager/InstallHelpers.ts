...
interface IPnpmPackageJson extends IPackageJson {
  pnpm?: Partial<
    Pick<PnpmOptionsConfiguration, 'neverBuiltDependencies' | 'overrides' | 'packageExtensions'>
  >;
}
...
export class InstallHelpers {
  public static generateCommonPackageJson(
    ...
    const commonPackageJson: IPnpmPackageJson = {
      dependencies: {},
