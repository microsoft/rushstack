...
export class PnpmOptionsConfiguration extends PackageManagerOptionsConfigurationBase {
   ...
   * for all dependencies of all projects in the monorepo workspace.
   *
   * For pnpm < 11: the settings are copied into the `pnpm.overrides` field of the
   * `common/temp/package.json` file that is generated by Rush during installation.
   *
   * For pnpm >= 11: the settings are written to the `overrides` field of the
   ...
   * that are reported during installation with `strictPeerDependencies=true`.
   *
   * For pnpm < 11: the settings are copied into the `pnpm.peerDependencyRules` field of the
   * `common/temp/package.json` file that is generated by Rush during installation.
   *
   * For pnpm >= 11: the settings are written to the `peerDependencyRules` field of the
   * `pnpm-workspace.yaml` file that is generated by Rush during installation.
   *
   * Order of precedence: `.pnpmfile.cjs` has the highest precedence, followed by
   * `unsupportedPackageJsonSettings`, `globalPeerDependencyRules`, `globalPackageExtensions`,
   ...
   * for any PNPM dependency of the monorepo.
   ...
   *
   * For pnpm < 11: the settings are copied into the `pnpm.packageExtensions` field of the
   * `common/temp/package.json` file that is generated by Rush during installation.
   *
   * For pnpm >= 11: the settings are written to the `packageExtensions` field of the
   * `pnpm-workspace.yaml` file that is generated by Rush during installation.
   *
   * Order of precedence: `.pnpmfile.cjs` has the highest precedence, followed by
   * `unsupportedPackageJsonSettings`, `globalPeerDependencyRules`, `globalPackageExtensions`,
   ...
   *
   * For pnpm < 11: the settings are copied into the `pnpm.neverBuiltDependencies` field of the
   * `common/temp/package.json` file that is generated by Rush during installation.
   *
   * For pnpm >= 11: `neverBuiltDependencies` was removed; Rush converts each entry to
   * `allowBuilds: { "<dep>": false }` in the `pnpm-workspace.yaml` file.
   *
   ...
   *
   * For pnpm < 11: the settings are copied into the `pnpm.onlyBuiltDependencies` field of the
   * `common/temp/package.json` file that is generated by Rush during installation.
   *
   * For pnpm >= 11: `onlyBuiltDependencies` was removed; Rush converts each entry to
   * `allowBuilds: { "<dep>": true }` in the `pnpm-workspace.yaml` file.
   *
   ...
   * dependencies.
   *
   * For pnpm < 11: the settings are copied into the `pnpm.ignoredOptionalDependencies` field of the
   * `common/temp/package.json` file that is generated by Rush during installation.
   *
   * For pnpm >= 11: the settings are written to the `ignoredOptionalDependencies` field of the
   * `pnpm-workspace.yaml` file that is generated by Rush during installation.
   *
   ...
   *
   * For pnpm < 11: the settings are copied into the `pnpm.allowedDeprecatedVersions` field of the
   * `common/temp/package.json` file that is generated by Rush during installation.
   *
   * For pnpm >= 11: the settings are written to the `allowedDeprecatedVersions` field of the
   * `pnpm-workspace.yaml` file that is generated by Rush during installation.
   *
  ...
  /**
   * (USE AT YOUR OWN RISK)  This is a free-form property bag for experimenting with PNPM features.
   *
   * For pnpm < 11: the entire object is copied into the `common/temp/package.json` file.
   * Any `pnpm.*` settings you need belong under a `"pnpm"` key within this object.
   *
   * For pnpm >= 11: pnpm no longer reads the `pnpm` key from `package.json`.  If this object
   * contains a `"pnpm"` sub-object, Rush will extract it and merge its fields at the top level of
   * `pnpm-workspace.yaml` instead.  Other top-level keys in this object are still written to
   ...
   *
   * For pnpm < 11: the settings are copied into the `pnpm.patchedDependencies` field of the
   * `common/temp/package.json` file that is generated by Rush during installation.
   *
   * For pnpm >= 11: the settings are written to the `patchedDependencies` field of the
   * `pnpm-workspace.yaml` file that is generated by Rush during installation.
   *
