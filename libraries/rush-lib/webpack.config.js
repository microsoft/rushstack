...
module.exports = () => {
  ...
  const configurations = [
    generateConfiguration(
      {
        'rush-lib': `${__dirname}/lib-esm/index.js`,
        start: `${__dirname}/lib-esm/start.js`,
        startx: `${__dirname}/lib-esm/startx.js`,
        'start-pnpm': `${__dirname}/lib-esm/start-pnpm.js`
      },
      [
    ...
    generateConfiguration({
      [PathConstants.pnpmfileShimFilename]: {
        import: `${__dirname}/lib-esm/logic/pnpm/PnpmfileShim.js`,
        ...SCRIPT_ENTRY_OPTIONS
      },
      [PathConstants.subspacePnpmfileShimFilename]: {
        import: `${__dirname}/lib-esm/logic/pnpm/SubspaceGlobalPnpmfileShim.js`,
        ...SCRIPT_ENTRY_OPTIONS
      },
      [PathConstants.installRunScriptFilename]: {
        import: `${__dirname}/lib-esm/scripts/install-run.js`,
        ...SCRIPT_ENTRY_OPTIONS
      },
      [PathConstants.installRunRushScriptFilename]: {
        import: `${__dirname}/lib-esm/scripts/install-run-rush.js`,
        ...SCRIPT_ENTRY_OPTIONS
      },
      [PathConstants.installRunRushxScriptFilename]: {
        import: `${__dirname}/lib-esm/scripts/install-run-rushx.js`,
        ...SCRIPT_ENTRY_OPTIONS
      },
      [PathConstants.installRunRushPnpmScriptFilename]: {
        import: `${__dirname}/lib-esm/scripts/install-run-rush-pnpm.js`,
        ...SCRIPT_ENTRY_OPTIONS
      }
    })
  ];
