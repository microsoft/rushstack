...
describe('PackageName', () => {
  describe('Test', () => {
    ...
    test('tryParse() tests', () => {
      expect(PackageName.tryParse('@microsoft/node-core-library')).toEqual({
        scope: '@microsoft',
      ...
      expect(PackageName.tryParse('@/node-core-library')).toEqual({
        scope: '@',
        unscopedName: 'node-core-library',
      ...
      expect(PackageName.tryParse('@micro!soft/node-core-library')).toEqual({
        scope: '@micro!soft',
        unscopedName: 'node-core-library',
      ...
      expect(PackageName.tryParse('@microsoft/node-core-library/path')).toEqual({
        scope: '@microsoft',
  ...
  test('combineParts() tests', () => {
    expect(PackageName.combineParts('@microsoft', 'node-core-library')).toEqual(
      '@microsoft/node-core-library'
    );

    expect(PackageName.combineParts('', 'node-core-library')).toEqual('node-core-library');
  });
